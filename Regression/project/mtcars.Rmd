...
## Model Selection
The model selection process began by fitting a simple model with transmission predicting economy. From here, additional candidate variables were tried one at a time. I observed one of three outcomes when including the variable:
...
The best model of fuel economy found which also includes transmission is:
**latex** `mpg = 31 - 0.059 * hp - 5.28 * auto`
...
*are there points above the intersect?*
